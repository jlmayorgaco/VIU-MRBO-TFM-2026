...
def _numbers(
    ...
    macros = {
        ...
        "SPFourRepTimeout": f"{v3.loc['replicator_primitives', 'timeout']:.3f}",
        "SPFourCBFTimeout": f"{v3.loc['cbf_qp', 'timeout']:.3f}",
        ...
        "SPFourDistributedTime": f"{trans.loc['distributed_preview_cbf', 'time_to_target_s_mean']:.2f}",
        "SPFourDistributedWork": f"{trans.loc['distributed_preview_cbf', 'mechanical_work_j_mean']:.1f}",
