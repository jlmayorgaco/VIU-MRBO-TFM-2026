...
.PHONY: install test test-fast test-smoke test-full lint report-pdf build-report validate-suite smoke-exp run-canonical method-matrix regime-map theory-validation stats-annex figures-paper video-catalog sp9 thesis reproduce-figures submit-check clean-generated clean
...
run-canonical:
	$(PYTHON) scripts/run_sp1_experiment.py configs/experiments/sp1/SP1_MC_recruitment_comparison.yaml
	$(PYTHON) scripts/run_sp2_experiment.py configs/experiments/sp2/SP2_MC_capacity_comparison.yaml
	$(PYTHON) scripts/run_sp3_experiment.py configs/experiments/sp3/SP3_MC_wrench_comparison_methodology_v3.yaml
	$(PYTHON) scripts/run_sp4_experiment.py configs/experiments/sp4/SP4_MC_motion_comparison.yaml
