...
| Auction + reciprocal proxy | 0.00 | 5.22 | 5.22 | 108.87 | 14.72 |
| Auction + predictive CBF proxy | 0.00 | 9.83 | 9.83 | 137.75 | 14.72 |
| Replicator + CBF (TFM) | 0.00 | 4.33 | 4.45 | 60.52 | 750.11 |
...
La variante continua registró **0** intervenciones del guard de último recurso y un residual EXEC máximo de **7.582e-02**. RAW, SAFE y EXEC se conservan por separado; estos datos muestreados no constituyen una prueba de invariancia continua.
