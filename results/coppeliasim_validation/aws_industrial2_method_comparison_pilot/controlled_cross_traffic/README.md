...
| --- | ---: | ---: | ---: | ---: | ---: |
| Central MILP + preview | 0.00 | 10.45 | 10.45 | 81.09 | 0.00 |
| Auction + reciprocal proxy | 0.00 | 5.22 | 5.22 | 118.92 | 14.72 |
| Auction + predictive CBF proxy | 0.00 | 9.83 | 9.83 | 139.78 | 14.72 |
| Replicator + CBF (TFM) | 0.00 | 2.17 | 2.45 | 51.17 | 1002.66 |
...
La variante continua registró **0** intervenciones del guard de último recurso y un residual EXEC máximo de **7.602e-02**. RAW, SAFE y EXEC se conservan por separado; estos datos muestreados no constituyen una prueba de invariancia continua.
