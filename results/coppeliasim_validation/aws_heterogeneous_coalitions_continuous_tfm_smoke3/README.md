...
| --- | ---: | ---: | ---: | ---: | ---: |
| MILP-Q | 1.00 | 7.85 | 7.85 | 94.48 | 0.00 |
| Greedy-Q | 1.00 | 8.47 | 8.47 | 93.50 | 0.04 |
| Random-Q | 0.00 | 0.00 | 0.00 | 66.53 | 59.42 |
| Replicator-Q | 0.00 | 6.90 | 7.45 | 62.34 | 500.46 |
...
| MILP-Q − Random-Q | 1.000 | [1.000, 1.000] | 1.0000 | no concluyente |
| MILP-Q − Replicator-Q | 1.000 | [1.000, 1.000] | 1.0000 | no concluyente |
| Greedy-Q − Random-Q | 1.000 | [1.000, 1.000] | 1.0000 | no concluyente |
| Greedy-Q − Replicator-Q | 1.000 | [1.000, 1.000] | 1.0000 | no concluyente |
...
La variante continua registró **5353** intervenciones del guard de último recurso y un residual EXEC máximo de **5.473e-02**. RAW, SAFE y EXEC se conservan por separado; estos datos muestreados no constituyen una prueba de invariancia continua.
