...
| --- | ---: | ---: | ---: | ---: | ---: |
| MILP-Q | 0.00 | 8.35 | 8.35 | 39.94 | 0.00 |
| Greedy-Q | 0.00 | 4.97 | 4.97 | 41.24 | 0.08 |
| Random-Q | 0.00 | 0.00 | 0.00 | 29.86 | 59.42 |
| Replicator-Q | 0.00 | 0.00 | 0.00 | 25.36 | 500.46 |

## Contrastes pareados de entregas

| A − B | Diferencia | IC95 % | p Holm | Decisión |
| --- | ---: | ---: | ---: | --- |
| MILP-Q − Greedy-Q | 0.000 | [0.000, 0.000] | 1.0000 | no concluyente |
| MILP-Q − Random-Q | 0.000 | [0.000, 0.000] | 1.0000 | no concluyente |
| MILP-Q − Replicator-Q | 0.000 | [0.000, 0.000] | 1.0000 | no concluyente |
| Greedy-Q − Random-Q | 0.000 | [0.000, 0.000] | 1.0000 | no concluyente |
| Greedy-Q − Replicator-Q | 0.000 | [0.000, 0.000] | 1.0000 | no concluyente |
| Random-Q − Replicator-Q | 0.000 | [0.000, 0.000] | 1.0000 | no concluyente |
...
La variante continua registró **3639** intervenciones del guard de último recurso y un residual EXEC máximo de **1.919e-02**. RAW, SAFE y EXEC se conservan por separado; estos datos muestreados no constituyen una prueba de invariancia continua.
