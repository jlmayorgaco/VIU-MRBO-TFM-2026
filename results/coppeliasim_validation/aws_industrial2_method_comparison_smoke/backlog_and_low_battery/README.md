...
| Auction + reciprocal proxy | 0.00 | 5.17 | 5.17 | 62.62 | 13.86 |
| Auction + predictive CBF proxy | 0.00 | 5.78 | 5.78 | 61.46 | 13.86 |
| Replicator + CBF (TFM) | 0.00 | 4.30 | 4.30 | 50.79 | 500.00 |
...
La variante continua registró **0** intervenciones del guard de último recurso y un residual EXEC máximo de **7.239e-02**. RAW, SAFE y EXEC se conservan por separado; estos datos muestreados no constituyen una prueba de invariancia continua.
