...
| --- | ---: | ---: | ---: | ---: | ---: |
| MILP-Q | 1.62 | 11.24 | 11.26 | 110.15 | 0.00 |
| Greedy-Q | 2.00 | 14.03 | 14.10 | 101.23 | 0.03 |
| Random-Q | 1.38 | 22.78 | 22.88 | 114.78 | 19.81 |
| Replicator-Q | 1.88 | 15.99 | 16.24 | 108.94 | 262.66 |

## Contrastes pareados de entregas

| A − B | Diferencia | IC95 % | p Holm | Decisión |
| --- | ---: | ---: | ---: | --- |
| MILP-Q − Greedy-Q | -0.375 | [-0.750, -0.125] | 1.0000 | no concluyente |
| MILP-Q − Random-Q | 0.250 | [-0.375, 0.750] | 1.0000 | no concluyente |
| MILP-Q − Replicator-Q | -0.250 | [-0.625, 0.000] | 1.0000 | no concluyente |
| Greedy-Q − Random-Q | 0.625 | [0.250, 0.875] | 0.3750 | no concluyente |
| Greedy-Q − Replicator-Q | 0.125 | [0.000, 0.375] | 1.0000 | no concluyente |
| Random-Q − Replicator-Q | -0.500 | [-0.875, 0.000] | 1.0000 | no concluyente |
...
La variante continua registró **0** intervenciones del guard de último recurso y un residual EXEC máximo de **2.252e-01**. RAW, SAFE y EXEC se conservan por separado; estos datos muestreados no constituyen una prueba de invariancia continua.
