# SP3_MC_wrench_comparison_methodology_v3
...
|---:|---|---|---|---:|---:|---:|---:|---:|---:|
| 1 | wrench_oracle | model_based_oracle | reference | 1.000 | 1.000 | 0.000 | 0.000 | 0.000 | 128.659 |
| 2 | smith_wrench_marginal | model_based | proposed | 1.000 | 0.500 | 0.500 | 0.000 | 0.092 | 26.411 |
| 3 | bnn_wrench_deficit | model_based | baseline | 1.000 | 0.500 | 0.500 | 0.000 | 0.092 | 28.984 |
| 4 | replicator_wrench_deficit | model_based | baseline | 1.000 | 0.500 | 0.500 | 0.000 | 0.092 | 29.079 |
| 5 | smith_wrench_deficit | model_based | proposed | 1.000 | 0.500 | 0.500 | 0.000 | 0.092 | 28.764 |
| 6 | oracle_scalar_assignment | model_based_oracle | reference | 1.000 | 0.500 | 0.500 | 0.000 | 0.093 | 21.013 |
| 7 | hungarian_slots | classic | baseline | 1.000 | 0.500 | 0.500 | 0.000 | 0.093 | 0.086 |
| 8 | cbba_slots | sota | baseline | 1.000 | 0.500 | 0.500 | 0.000 | 0.093 | 26.327 |
| 9 | support_dual_wrench_market | model_based | proposed | 1.000 | 0.500 | 0.500 | 0.000 | 0.093 | 8.812 |
| 10 | capacity_greedy_slots | classic | baseline | 1.000 | 0.500 | 0.500 | 0.000 | 0.101 | 0.260 |
...
|---|---|---:|---:|---:|---:|---|---|---|
| H3_1_scalar_false_positives_rotational_loads | false_positive_rate | 600 | 6.03e-61 | 2.41e-60 | 0.5000 | [0.4583, 0.54] | True | ok |
| H3_2_smith_wrench_lower_residual_than_smith_capacity | wrench_residual_feasible_available | 600 | 0.6435 | 1.0000 | 4.01e-19 | [-1.882e-18, 2.61e-18] | False | ok |
| H3_3_capacity_greedy_more_infeasible_assignments_than_support_dual | fp_given_assigned | 600 | 0.5000 | 1.0000 | 0.0000 | [0, 0] | False | ok |
| H3_4_support_dual_lower_gap_than_cbba | optimality_gap_vs_wrench_oracle | 600 | 0.9942 | 1.0000 | 4.52e-05 | [-0.0004984, 0.0005805] | False | ok |
| H3_5_methods_differ_wrench_gap | optimality_gap_vs_wrench_oracle | 600 | 2.58e-95 | 1.29e-94 | 0.1096 |  | True | ok |
