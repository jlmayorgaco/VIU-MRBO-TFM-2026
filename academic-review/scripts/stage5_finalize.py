...
"""
    ...
    claims = [
        {"claim_id": "C01", "claim": f"El derivado Stage 1C contiene {len(corpus)} candidatos y la cola Stage 2 contiene {len(matrix)} registros.", "claim_type": "review_descriptive", "support_status": "supported_by_frozen_outputs", "candidate_id": "", "DOI": "", "evidence_location": "data/processed/candidate_corpus_stage2.csv;data/processed/fulltext_evidence_matrix.csv", "source_artifacts": "data/processed/candidate_corpus_stage2.csv;data/processed/fulltext_evidence_matrix.csv", "source_candidate_ids": "", "allowed_use": "metodología de revisión"},
        {"claim_id": "C02", "claim": f"Se verificaron {evidence_counts['fulltext_verified']} objetos de texto completo mediante identidad DOI/título.", "claim_type": "acquisition_descriptive", "support_status": "supported_by_stage2_log", "candidate_id": fulltext_ids, "DOI": fulltext_dois, "evidence_location": "logs/stage2_fulltext_acquisition.csv;reports/stage2_acquisition_qa.md", "source_artifacts": "logs/stage2_fulltext_acquisition.csv;reports/stage2_acquisition_qa.md", "source_candidate_ids": fulltext_ids, "allowed_use": "describir cobertura de evidencia"},
        {"claim_id": "C03", "claim": "Las señales de método, teoría, física y experimentación son indicadores de coding estructural, no verificación de resultados.", "claim_type": "evidence_boundary", "support_status": "supported_by_protocol", "candidate_id": "", "DOI": "", "evidence_location": "reports/stage3_fulltext_qa.md;config/stage3_codebook.yaml", "source_artifacts": "reports/stage3_fulltext_qa.md;config/stage3_codebook.yaml", "source_candidate_ids": "", "allowed_use": "limitación metodológica"},
        {"claim_id": "C04", "claim": "La combinación completa SP1-SP3 no puede declararse ausente ni novedosa con el corpus actual.", "claim_type": "novelty_boundary", "support_status": "unresolved_hypothesis", "candidate_id": prior_ids, "DOI": prior_dois, "evidence_location": "reports/adversarial_novelty_audit.md;tables/stage4_analysis_summary.json", "source_artifacts": "reports/adversarial_novelty_audit.md;tables/stage4_analysis_summary.json", "source_candidate_ids": prior_ids, "allowed_use": "auditoría de novedad, no claim final"},
        {"claim_id": "C05", "claim": "El siguiente paso requerido es lectura cercana de prior art, exportación WoS y validación experimental según el protocolo del repositorio.", "claim_type": "research_action", "support_status": "required_by_limitations", "candidate_id": "", "DOI": "", "evidence_location": "final/tfm_integration_plan.md;reports/stage4_synthesis_qa.md", "source_artifacts": "final/tfm_integration_plan.md;reports/stage4_synthesis_qa.md", "source_candidate_ids": "", "allowed_use": "plan de trabajo"},
    ]
