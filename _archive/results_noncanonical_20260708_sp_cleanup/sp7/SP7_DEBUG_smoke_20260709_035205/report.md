...
- ALL_SCENARIOS rank 4: `classic_centralized_global_mpc` score=0.240, connectivity=0.549.
...
- setup rank 4: `classic_centralized_global_mpc` score=0.240, connectivity=0.549.
