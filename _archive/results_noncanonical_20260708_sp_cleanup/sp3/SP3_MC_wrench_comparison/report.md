...
| Rank | Method | Family | Owner | Wrench feasible | False positive | Residual | Gap | Runtime ms |
|---:|---|---|---|---:|---:|---:|---:|---:|
| 1 | wrench_oracle | model_based_oracle | reference | 0.500 | 0.000 | 0.604 | 0.000 | 148.475 |
| 2 | smith_wrench_marginal | model_based | proposed | 0.500 | 0.488 | 0.354 | 0.092 | 30.261 |
| 3 | bnn_wrench_deficit | model_based | baseline | 0.500 | 0.500 | 0.354 | 0.092 | 33.469 |
| 4 | replicator_wrench_deficit | model_based | baseline | 0.500 | 0.500 | 0.355 | 0.092 | 33.163 |
| 5 | smith_wrench_deficit | model_based | proposed | 0.500 | 0.500 | 0.354 | 0.092 | 32.996 |
| 6 | oracle_scalar_assignment | model_based_oracle | reference | 0.500 | 0.500 | 0.361 | 0.093 | 23.074 |
| 7 | hungarian_slots | classic | baseline | 0.500 | 0.498 | 0.361 | 0.093 | 0.095 |
| 8 | cbba_slots | sota | baseline | 0.500 | 0.165 | 0.371 | 0.093 | 29.797 |
| 9 | support_dual_wrench_market | model_based | proposed | 0.500 | 0.500 | 0.353 | 0.093 | 10.008 |
| 10 | capacity_greedy_slots | classic | baseline | 0.500 | 0.500 | 0.403 | 0.101 | 0.296 |
...
| H3_2_smith_wrench_lower_residual_than_smith_capacity | wrench_residual_norm | 600 | 0.5132 | -0.0483 | False | ok |
| H3_3_capacity_greedy_more_false_positives_than_support_dual | false_positive_rate | 600 | 0.5000 | 0.0000 | False | ok |
...
- `bar_torque_pure` `cbba_slots` seed `4100`: `sp3_bar-torque-pure_baseline_sota_decentralized_cbba-slot-wrench-proxy_cbba-slots_seed4100.mp4`
- `bar_torque_pure` `replicator_wrench_deficit` seed `4100`: `sp3_bar-torque-pure_baseline_model-based_decentralized_replicator-wrench-deficit_replicator-wrench-deficit_seed4100.mp4`
- `bar_torque_pure` `bnn_wrench_deficit` seed `4100`: `sp3_bar-torque-pure_baseline_model-based_decentralized_bnn-wrench-deficit_bnn-wrench-deficit_seed4100.mp4`
- `bar_torque_pure` `wrench_oracle` seed `4100`: `sp3_bar-torque-pure_reference_model-based-oracle_centralized_exact-role-slot-wrench_wrench-oracle_seed4100.mp4`
...
- `long_payload_slots` `smith_wrench_marginal` seed `4100`: `sp3_long-payload-slots_proposed_model-based_decentralized_smith-qr-delta-rho-wrench-marginal_smith-wrench-marginal_seed4100.mp4`
- `long_payload_slots` `smith_wrench_deficit` seed `4100`: `sp3_long-payload-slots_proposed_model-based_decentralized_smith-qr-wrench-deficit_smith-wrench-deficit_seed4100.mp4`
- `long_payload_slots` `replicator_wrench_deficit` seed `4100`: `sp3_long-payload-slots_baseline_model-based_decentralized_replicator-wrench-deficit_replicator-wrench-deficit_seed4100.mp4`
- `long_payload_slots` `bnn_wrench_deficit` seed `4100`: `sp3_long-payload-slots_baseline_model-based_decentralized_bnn-wrench-deficit_bnn-wrench-deficit_seed4100.mp4`
...
- `off_center_com` `smith_wrench_marginal` seed `4100`: `sp3_off-center-com_proposed_model-based_decentralized_smith-qr-delta-rho-wrench-marginal_smith-wrench-marginal_seed4100.mp4`
...
- `off_center_com` `support_dual_wrench_market` seed `4100`: `sp3_off-center-com_proposed_model-based_decentralized_residual-support-wrench-market_support-dual-wrench-market_seed4100.mp4`
- `off_center_com` `hungarian_slots` seed `4100`: `sp3_off-center-com_baseline_classic_centralized_hungarian-robot-slot-cost_hungarian-slots_seed4100.mp4`
- `off_center_com` `oracle_scalar_assignment` seed `4100`: `sp3_off-center-com_reference_model-based-oracle_centralized_exact-scalar-capacity-reference_oracle-scalar-assignment_seed4100.mp4`
...
- `one_sided_push` `hungarian_slots` seed `4100`: `sp3_one-sided-push_baseline_classic_centralized_hungarian-robot-slot-cost_hungarian-slots_seed4100.mp4`
- `one_sided_push` `oracle_scalar_assignment` seed `4100`: `sp3_one-sided-push_reference_model-based-oracle_centralized_exact-scalar-capacity-reference_oracle-scalar-assignment_seed4100.mp4`
- `one_sided_push` `support_dual_wrench_market` seed `4100`: `sp3_one-sided-push_proposed_model-based_decentralized_residual-support-wrench-market_support-dual-wrench-market_seed4100.mp4`
- `one_sided_push` `replicator_wrench_deficit` seed `4100`: `sp3_one-sided-push_baseline_model-based_decentralized_replicator-wrench-deficit_replicator-wrench-deficit_seed4100.mp4`
...
- `point_load_degenerate` `smith_wrench_marginal` seed `4100`: `sp3_point-load-degenerate_proposed_model-based_decentralized_smith-qr-delta-rho-wrench-marginal_smith-wrench-marginal_seed4100.mp4`
- `point_load_degenerate` `bnn_wrench_deficit` seed `4100`: `sp3_point-load-degenerate_baseline_model-based_decentralized_bnn-wrench-deficit_bnn-wrench-deficit_seed4100.mp4`
- `point_load_degenerate` `replicator_wrench_deficit` seed `4100`: `sp3_point-load-degenerate_baseline_model-based_decentralized_replicator-wrench-deficit_replicator-wrench-deficit_seed4100.mp4`
- `point_load_degenerate` `smith_wrench_deficit` seed `4100`: `sp3_point-load-degenerate_proposed_model-based_decentralized_smith-qr-wrench-deficit_smith-wrench-deficit_seed4100.mp4`
...
- `slot_saturation` `oracle_scalar_assignment` seed `4100`: `sp3_slot-saturation_reference_model-based-oracle_centralized_exact-scalar-capacity-reference_oracle-scalar-assignment_seed4100.mp4`
- `slot_saturation` `cbba_slots` seed `4100`: `sp3_slot-saturation_baseline_sota_decentralized_cbba-slot-wrench-proxy_cbba-slots_seed4100.mp4`
- `slot_saturation` `smith_wrench_marginal` seed `4100`: `sp3_slot-saturation_proposed_model-based_decentralized_smith-qr-delta-rho-wrench-marginal_smith-wrench-marginal_seed4100.mp4`
- `slot_saturation` `smith_wrench_deficit` seed `4100`: `sp3_slot-saturation_proposed_model-based_decentralized_smith-qr-wrench-deficit_smith-wrench-deficit_seed4100.mp4`
