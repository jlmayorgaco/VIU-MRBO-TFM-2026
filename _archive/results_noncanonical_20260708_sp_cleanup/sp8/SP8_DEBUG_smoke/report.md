...
## Primary Ranking
- ALL_SCENARIOS rank 1: `ours_wrench_market_hierarchical` completion=0.250, timeout=0.000, runtime=1.80 ms.
- ALL_SCENARIOS rank 2: `centralized_coalition_oracle` completion=0.250, timeout=0.000, runtime=2.03 ms.
- ALL_SCENARIOS rank 3: `ours_mean_field_approximation` completion=0.188, timeout=0.000, runtime=1.44 ms.
- ALL_SCENARIOS rank 4: `cbba_partitioned` completion=0.188, timeout=0.000, runtime=5.88 ms.
- ALL_SCENARIOS rank 5: `classic_local_greedy` completion=0.188, timeout=0.000, runtime=2.10 ms.
- ALL_SCENARIOS rank 6: `centralized_hungarian_expanded` completion=0.125, timeout=0.000, runtime=0.11 ms.
- debug rank 1: `ours_wrench_market_hierarchical` completion=0.250, timeout=0.000, runtime=1.80 ms.
- debug rank 2: `centralized_coalition_oracle` completion=0.250, timeout=0.000, runtime=2.03 ms.
- debug rank 3: `ours_mean_field_approximation` completion=0.188, timeout=0.000, runtime=1.44 ms.
- debug rank 4: `cbba_partitioned` completion=0.188, timeout=0.000, runtime=5.88 ms.
- debug rank 5: `classic_local_greedy` completion=0.188, timeout=0.000, runtime=2.10 ms.
