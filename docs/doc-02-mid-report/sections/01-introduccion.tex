...
Un solo robot puede mover cada una de tres cajas ligeras. Una paleta industrial
...
grupo es la variable de diseño: la flota debe resolver localmente cuántos
robots asigna a cada tarea, y esa decisión debe producir coaliciones factibles
dentro del horizonte de operación. Los métodos de
...
coordinación desde una perspectiva discreta o negociada; en el corpus revisado,
...
(cada agente solo necesita información local) que convergen al
...
de UAVs con datos reales. Más recientemente, \citet{dinh2026bsplines} proponen
...
tarea es fijo y conocido de antemano. Tampoco se identificó, en esa línea, un
tratamiento explícito del caso en que la tarea impone un requisito mínimo
de cardinalidad que deba satisfacerse dinámicamente.
