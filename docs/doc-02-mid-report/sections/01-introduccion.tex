...
tamaño exactamente adecuado para cada tarea. Se trata de un problema de asignación
distribuida con restricciones de cardinalidad mínima que deben cumplirse en tiempo
real, sin coordinador central y con comunicación limitada al entorno inmediato de
cada robot; difiere así de la planificación de rutas y del seguimiento de formación fija.
