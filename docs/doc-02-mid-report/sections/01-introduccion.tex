...
y admite distintas dinámicas de revisión (replicador y Smith), en contraste con las
restricciones de capacidad de \citet{martinezpiazuelo2022automatica}, que son cotas
superiores. Sobre esa función se adaptan y comparan el replicador distribuido y las
dinámicas de Smith bajo idénticas condiciones experimentales y la misma arquitectura
de estimación por consenso dinámico de media. A ello se añade una tasa de revisión
espacialmente modulada que reduce las reasignaciones espurias en estado estacionario.
Por último, se caracteriza empíricamente el coste de descentralización frente a una
referencia centralizada con información global, junto con la degradación del desempeño
al reducir el rango de comunicación. El resultado es una arquitectura distribuida
acoplada cuya viabilidad cinemática se valida cualitativamente en CoppeliaSim con
robots Pioneer~3-DX.
