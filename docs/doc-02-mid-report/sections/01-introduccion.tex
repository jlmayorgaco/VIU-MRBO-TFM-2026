...
Esta interpretación produce leyes de control sin coordinador central de asignación
(cada agente sólo necesita información local) que convergen al
equilibrio Nash bajo condiciones de juego potencial.
...
% TODO-VOZ: revisar cadencia de enumerador (voz propia)
...
y tasa de revisión espacialmente modulada) no se ha identificado en el corpus
bibliográfico revisado (21 referencias en 6 áreas temáticas). Cada
...
% TODO-VOZ: reformular estructura no-es-X-es-Y
