...
inferior sigmoidal de cardinalidad que preserva, en el caso base ($\Psi\equiv1$), la
estructura de juego de congestión y admite distintas dinámicas de revisión
(replicador y Smith), en contraste con las
