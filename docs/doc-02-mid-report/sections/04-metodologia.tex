...
El transporte del cluster incorpora evitación reactiva de obstáculos estáticos a
...
condición $r_0 < r/2$ hace que $x_0^* = 0$ sea consistente con el equilibrio. En el
...
Conviene distinguir tres medidas de ocupación de la tarea $k$: la \emph{ocupación
...
el denominador. Este término es una heurística reactiva de simulación: no sustituye
una planificación global de rutas ni certifica la ausencia de colisiones.
...
centroide en movimiento. De este modo el cluster puede desviar su trayectoria
colectiva ante obstáculos estáticos sin disolver la coalición. El modelo permanece
cinemático: no se simulan fuerzas de contacto sobre la carga. La evitación a nivel de
cluster se evalúa empíricamente en los escenarios con obstáculos y cualitativamente en
