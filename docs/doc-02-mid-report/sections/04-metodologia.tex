...
El código, los archivos de configuración, las semillas aleatorias, las trayectorias,
las asignaciones, los grafos de comunicación, los payoffs y las métricas agregadas se
organizarán en un repositorio versionado. Para una eventual publicación, se generará
una versión archivada con DOI.
