...
empleada aquí, \citet{barreiro2017distributed} (Teorema~3) prueban la estabilidad
...
\emph{tiempo discreto} se sustenta en \citet{martinez2020formation} (Teorema~1), que
establecen la estabilidad asintótica de las dinámicas de Smith distribuidas en tiempo
discreto bajo una condición suficiente sobre el tamaño del paso de actualización,
inversamente proporcional al número máximo de vecinos en el grafo; el caso general en
tiempo discreto se trata en \citet{martinezpiazuelo2022tcss}. Esta cota sobre el paso
