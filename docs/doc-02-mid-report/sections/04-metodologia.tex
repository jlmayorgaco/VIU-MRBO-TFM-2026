...
Este capítulo desarrolla la metodología del trabajo. En primer lugar se delimita el
alcance y las limitaciones del estudio y se sitúa el plan de trabajo; a continuación
se formaliza el modelo del sistema y se describen las tres dinámicas acopladas que
constituyen el método. El capítulo cierra con el análisis de convergencia, el diseño
experimental, las métricas y los criterios de aceptación.
...
no como un óptimo absoluto. La metodología se organiza en quince subsecciones que cubren
...
payoff cuando todas las tareas están saturadas ($\Phi \approx 0$ para todo $k \geq 1$). El valor $r_0 = 0{,}05$ es suficientemente pequeño para
