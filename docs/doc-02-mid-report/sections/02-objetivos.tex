...
Diseñar y evaluar un esquema de coordinación distribuida local para la formación
adaptativa de coaliciones en flotas multi-AGV que transportan cargas con requisitos
mínimos de cardinalidad. El esquema se basa en consenso dinámico de media y dinámicas
poblacionales, e integra en un único bucle de control la estimación de ocupación, la
asignación a cargas, la formación de coaliciones y la navegación reactiva. Su evaluación,
mediante simulación cuantitativa reproducible, se organiza como una escalera comparativa
de cinco tratamientos (T1--T5) contrastada con una referencia centralizada replanificada
sobre seis escenarios experimentales.
