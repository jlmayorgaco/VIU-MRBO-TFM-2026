...
\begin{itemize}
  ...
  \item Líneas de trabajo futuro: extensión DRD-PI, tasas de revisión
    dependientes del grafo, generación de tareas en tiempo real, percepción local más
    realista y localización con incertidumbre.
  ...
  \item Perspectiva más amplia: de flotas homogéneas tipo unidad logística fija a flotas
    flexibles donde robots de distinta capacidad se agregan como un enjambre para mover
    cargas de demanda variable.
\end{itemize}
