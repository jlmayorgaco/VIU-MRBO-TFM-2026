...
Los resultados se obtendrán de la campaña experimental descrita en la
Sección~\ref{subsec:experimental} e incluirán:

\begin{itemize}
  \item Validación numérica del Teorema~\ref{prop:convergencia}
