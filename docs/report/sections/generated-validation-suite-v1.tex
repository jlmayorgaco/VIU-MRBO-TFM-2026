...
\midrule
H1 & Smith no reproduce water-filling en el caso homogÃ©neo. & Smith converge al reparto water-filling en equilibrio homogÃ©neo. & Equivalencia determinista de pendiente y R2.; n=5 puntos de control; p=n/a; IC95=n/a & $H_0$ refutada por prueba matemÃ¡tica y gate exacto. VÃ¡lida bajo simetrÃ­a, comunicaciÃ³n global y payoff homogÃ©neo. \\
H2 & La asignaciÃ³n fluida no genera conflicto entero relevante. & Existen coaliciones fluidas parciales que exigen clearing entero. & Binomial unilateral sobre conflicto fluido-entero.; n=252; p=\textless{}0.001; IC95=n/a & $H_0$ rechazada; el clearing entero queda justificado. Mide necesidad de clearing, no superioridad universal en navegaciÃ³n. \\
H3-A & El precio estÃ¡tico mejora o no empeora a Smith. & Existe rÃ©gimen estÃ¡tico donde el precio empeora a Smith. & Contraejemplo con IC95 unilateral negativo.; n=20; p=0.013; IC95=[-0.0774, -0.0051] & $H_0$ de mejora universal rechazada. Resultado negativo: no invalida el precio temporal. \\
H3-B & El precio temporal no mejora captura bajo deadlines. & El precio temporal mejora captura bajo dÃ©ficit y deadlines. & Delta pareado con IC95 positivo.; n=20; p=\textless{}0.001; IC95=[0.0029, 0.0121] & $H_0$ rechazada en el rÃ©gimen temporal controlado. VÃ¡lida para urgencia, no para equilibrio estÃ¡tico. \\
\bottomrule
\end{tabularx}
\end{table}
...
Prot. & $H_0$ & $H_1$ & Contraste & DecisiÃ³n y alcance \\
\midrule
H4 & Smith original mantiene captura operativa en R3. & Smith original cae por debajo del umbral operativo en R3. & t unilateral contra captura mÃ­nima 0.20.; n=20; p=\textless{}0.001; IC95=[0.0650, 0.1427] & $H_0$ rechazada; R3 es rÃ©gimen de fallo de Smith. Fallo operativo bajo comunicaciÃ³n degradada, no bajo conectividad global. \\
H5 & Smith-QR no mejora captura frente a Smith en R3. & Smith-QR mejora captura frente a Smith en R3. & t pareado unilateral sobre 20 semillas.; n=20; p=\textless{}0.001; IC95=[0.1434, 0.2276] & $H_0$ rechazada; mejora estadÃ­sticamente declarable. DeclaraciÃ³n limitada a captura de recompensa en R3. \\
H6 & Smith-QR domina tambiÃ©n en distancia desperdiciada frente a greedy. & La dominancia de Smith-QR no se extiende a todas las mÃ©tricas. & t pareado unilateral sobre distancia desperdiciada.; n=20; p=0.600; IC95=[-24.2001, 31.4817] & $H_0$ no rechazada; se reporta lÃ­mite operativo. Smith-QR es superior en captura, no dominante universal. \\
\bottomrule
\end{tabularx}
\end{table}
...
Prot. & $H_0$ & $H_1$ & Contraste & DecisiÃ³n y alcance \\
\midrule
H7 & Las escenas robÃ³ticas incumplen despejes mÃ­nimos o no exportan datos. & Las escenas robÃ³ticas son plausibles y exportan mÃ©tricas auditables. & Acceptance sampling muestral; sin inferencia poblacional.; n=6; p=n/a; IC95=n/a & $H_0$ muestral refutada; evidencia robÃ³tica observacional aceptada. No sustituye hardware ni benchmark estadÃ­stico principal. \\
...
G4 & Mercado, campo y Hamiltoniano no comparten el mismo dÃ©ficit. & Las tres capas consumen un dÃ©ficit comÃºn verificable. & No aplica; identidad algebraica.; n=gate algebraico; p=n/a; IC95=n/a & $H_0$ refutada hasta precisiÃ³n numÃ©rica. Depende de las hipÃ³tesis del contrato de integraciÃ³n. \\
G5 & La extensiÃ³n dinÃ¡mica viola los lÃ­mites de energÃ­a/torque. & La extensiÃ³n dinÃ¡mica mantiene energÃ­a y torque acotados. & No aplica; gate de estabilidad acotada.; n=gate algebraico; p=n/a; IC95=n/a & $H_0$ refutada en el caso controlado. Falta validar con campaÃ±as dinÃ¡micas de contacto realista. \\
G6 & El peaje predictivo no cambia rutas congestionadas. & El peaje predictivo anticipa congestiÃ³n y desvÃ­a flujo. & No aplica; gate determinista de ruta.; n=1 escenario controlado; p=n/a; IC95=n/a & $H_0$ refutada en el caso controlado. HipÃ³tesis extendida; requiere campaÃ±a de congestiÃ³n para generalizar. \\
G7 & La baterÃ­a no altera la asignaciÃ³n econÃ³mica. & La baterÃ­a actÃºa como restricciÃ³n econÃ³mica de retornabilidad. & No aplica; gate determinista de payoff.; n=1 escenario controlado; p=n/a; IC95=n/a & $H_0$ refutada en el caso controlado. Debe ampliarse con descarga temporal y rutas a cargador. \\
\bottomrule
\end{tabularx}
\end{table}
...
Protocolo & Criterio validado & Observado & Umbral & Estado \\
\midrule
G3-W & Cardinalidad no implica capacidad wrench: residual de coalicion apiÃ±ada & 1.1990 & \textgreater{}= 0.2500 & Pasa \\
