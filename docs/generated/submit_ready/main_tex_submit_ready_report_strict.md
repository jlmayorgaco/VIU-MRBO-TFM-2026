...
| info | page-budget | main-pages | The main document is within the configured page limit. | Main document: 63/80; appendices: 8/8; Introduction starts on PDF page 10, Appendix A on 73, and References on 67. |  |
| info | page-budget | appendix-pages | The appendices are within the configured page limit. | Main document: 63/80; appendices: 8/8; Introduction starts on PDF page 10, Appendix A on 73, and References on 67. |  |
