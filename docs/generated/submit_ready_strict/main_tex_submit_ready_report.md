...
| info | page-budget | main-pages | The main document is within the configured page limit. | Main document: 56/80; appendices: 7/8; Introduction starts on PDF page 11, Appendix A on 67, and References on 61. |  |
| info | page-budget | appendix-pages | The appendices are within the configured page limit. | Main document: 56/80; appendices: 7/8; Introduction starts on PDF page 11, Appendix A on 67, and References on 61. |  |
