%% ====================================================================
\section{Anexo teórico A: ecuaciones extendidas para auditoría}
\label{sec:anexo-teorico-extendido}
%% ====================================================================

Este anexo consolida las ecuaciones avanzadas que completan el marco teórico del
Capítulo~\ref{sec:marco}. No todas deben leerse como resultados cerrados del TFM. El
criterio de uso es el siguiente: los resultados marcados como \textbf{[ADOPTADO]} son
parte de la formulación teórica defendible; los marcados como \textbf{[CONDICIONADO]}
dependen de hipótesis técnicas pendientes; los marcados como \textbf{[FUTURO]} sirven
como frontera doctoral o programa de investigación.
...
extensión predictiva \textbf{[FUTURO]} o como perturbación acotada, no como parte de la
...
\end{equation}
Esta condición es la versión correcta que debe usarse al extender el presupuesto de
