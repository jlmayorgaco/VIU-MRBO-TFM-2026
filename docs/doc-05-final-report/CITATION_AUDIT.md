...
**Scope:** 110 entries; 61 cited keys in 123 included-source key-context uses
...
- The recursive 28-file LaTeX inclusion graph was rebuilt from `main.tex`.
...
- `CITATION_AUDIT.json`: 110-entry ledger and current source hashes.
