...
| SP2 | ¿Se cubre un umbral operacional cuando la contribución depende del par robot--carga? | Índice adimensional de servicio: carga útil normalizada ponderada por disponibilidad de batería y distancia; compatibilidad universal en la campaña | Score de déficit ponderado por contribución marginal; comparación separada de cobertura y completitud | MILP de score y MILP de cobertura normalizada; greedy, proxy CBBA y scorers supervisados | B parcial: proposición de alineación con $E$ fija + ablación extensa; estimación vecinal y factibilidad mecánica aún pendientes | Obligatorio |
