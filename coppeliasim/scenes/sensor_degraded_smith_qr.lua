...
-- Scenario: sensor_degraded_smith_qr
local scene = {
scenario = "sensor_degraded_smith_qr",
seed = 2031,
warehouse = {
...
name = "Operator_03",
position = {-17.3, 3.4, 0.9},
route = {{-17.3, 3.4000000000000004, 0.9}, {16.5, 4.4, 0.9}},
speed_mps = 0.75
}, {
name = "Operator_04",
position = {-17.3, -5.0, 0.9},
...
sensors = {
lidar_range_m = 4.1850000000000005,
proximity_range_m = 1.505,
load_detection_range_m = 1.0919999999999999,
blind_zones = {{
name = "BlindZone_RackA",
center = {-9.0, 0.0, 0.05},
size = {4.0, 2.0, 0.05}
}, {
name = "BlindZone_RackB",
center = {9.0, 4.0, 0.05},
size = {5.0, 2.5, 0.05}
}}
},
