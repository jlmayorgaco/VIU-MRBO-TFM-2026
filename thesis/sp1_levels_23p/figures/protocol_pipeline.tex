...
\node[bandTitle] at (1.00,9.91) {Bucle Monte Carlo pareado y registro crudo (RAW)};
...
\node[font=\fontsize{6.2}{6.9}\selectfont\sffamily\bfseries,
  text=SPGreen!45!black] at (12.225,8.54) {datos cerrados};
...
\node[font=\fontsize{6.8}{7.5}\selectfont\sffamily\bfseries,
  text=VIUDark,anchor=west] at (0.95,7.04) {DATOS SIN ALTERAR};
...
\node[bandTitle] at (1.00,6.11) {Procesamiento reproducible: datos $\rightarrow$ evidencia por mundo};
...
\node[smallBody] at (0.62,2.41)
  {continua $\rightarrow$ signo exacto (Wilcoxon: sensibilidad)};
...
\node[font=\fontsize{6.7}{7.4}\selectfont\sffamily\bfseries,
  ...
  {SÍ: rechazar $H_0$\\evidencia para $H_1$};
...
\node[font=\fontsize{6.6}{7.3}\selectfont\sffamily\bfseries,
  ...
  {NO: no rechazar $H_0$\\evidencia insuficiente};
