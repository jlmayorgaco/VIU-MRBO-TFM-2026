...
Una carga de SP1 requiere \(n_k\in\{1,2,3,4\}\) robots. Bajo escasez, dos perfiles con el mismo déficit pueden distribuir robots entre grupos parciales o concentrarlos en una carga completa. El beneficio de cuórum favorece la segunda configuración y QR convierte las preferencias en grupos de cardinalidad exacta. Las poses intervienen como parámetros de coste estático.
...
CBBA asigna un ganador por tarea y requeriría una extensión multi-ganador verificada para reproducir las cuotas de SP1 \parencite{choiBrunetHow2009CBBA}. Los métodos de coalición de \textcite{shehoryKraus1998Coalition,vigAdams2006Coalition} se usan como antecedentes metodológicos.
...
SP1 regula la cardinalidad de cada carga seleccionada. Para \(y\in\{0,1\}^K\), la salida estratégica es
\begin{equation}
...
\begin{table}[!htbp]
 ...
 \input{../results/sp1/SP1_QUORUM_v1/tables/sp1_method_summary.tex}
 \viuownsource
\end{table}
