...
El grafo de la Figura~\ref{fig:sp0-scenario} distingue asociaciones admisibles, selección y robot inactivo. Las aristas representan decisiones lógicas y no deben leerse como trayectorias ni como enlaces de comunicación.
...
\end{corolario}
Es una consecuencia directa de la Proposición~\ref{thm:sp0-nash-characterization}: cada actualización aceptada reduce estrictamente $F_\lambda$, el espacio de perfiles es finito y todo Nash satisface $D=E=0$; la demostración base está en el Anexo~\ref{app:sp0-proofs}. El resultado establece la estabilización de un conjunto lógico sobre eventos de revisión y no debe extenderse a estabilidad física ni a tiempo continuo.
