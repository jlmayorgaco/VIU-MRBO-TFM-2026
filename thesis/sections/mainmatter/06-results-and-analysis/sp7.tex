...
\begin{figure}[!htbp]
  \centering
  \begin{spdiagram}
    \spdrawarena{E7-C \textbar\ rutas, reserva vecinal y cuerpo compuesto}
  ...
  \end{spdiagram}
  \caption{E7-C: cada coalición elige ruta. Antes de entrar en la zona compartida solicita un testigo de paso con prioridad y envejecimiento.}
...
\begin{table}[!htbp]
  \centering
  \caption{Métodos comparados y alcance real de E7-C.}
...
\If{$c_i^{\mathrm{obj}}$ pertenece a una zona compartida y no se posee el testigo}
  ...
  \Else
    \State $w_i \gets w_i + 1$; \Return $c_i^+ \gets c_i$
...
\input{../legacy/results/processed/sp7/SP7_TRAFFIC_CONFIRMATORY_v1/tables/sp7_numbers.tex}
...
\begin{table}[!htbp]
  ...
  \scriptsize
  \resizebox{\textwidth}{!}{\input{../legacy/results/processed/sp7/SP7_TRAFFIC_CONFIRMATORY_v1/tables/sp7_results.tex}}
  \viuownsource
\end{table}
...
La evidencia cubre exclusión y progreso en el ejecutor discreto descrito. E8 reutiliza ese juego de rutas y degrada las vistas vecinales con escala, retardo y pérdida.
