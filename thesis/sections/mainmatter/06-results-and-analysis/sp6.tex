...
\begin{figure}[!htbp]
  \centering
  \begin{spdiagram}
    \spdrawarena{E6-C \textbar\ fallo, juego de reparación y guardia}
  ...
  \end{spdiagram}
  \caption{E6-C: la carga publica su déficit, las reservas revisan su participación y la guardia impide reabrir una coalición insuficiente.}
...
\begin{table}[!htbp]
  \centering
  \caption{Métodos ejecutados y alcance de comparación en E6-C.}
...
\input{../legacy/results/processed/sp6/SP6_RECOVERY_CONFIRMATORY_v1/tables/sp6_numbers.tex}
...
\begin{table}[!htbp]
  ...
  \scriptsize
  \resizebox{\textwidth}{!}{\input{../legacy/results/processed/sp6/SP6_RECOVERY_CONFIRMATORY_v1/tables/sp6_results.tex}}
  \viuownsource
\end{table}
