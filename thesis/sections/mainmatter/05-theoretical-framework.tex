...
\begin{equation}
\begin{aligned}
 \text{replicator:}\quad &\dot x_k=x_k(f_k-\bar f),\\
...
\begin{figure}[!htbp]
  ...
  \begin{tikzpicture}[
    ...
    \begin{scope}[shift={(0,4.05)}]
      ...
      \node[title,anchor=west] at (0.28,3.42) {Replicator: crecimiento relativo};
