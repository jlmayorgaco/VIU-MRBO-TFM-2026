...
E7 formaliza el tráfico sobre un grafo inflado con movimiento muestreado. El teorema de potencial usa catálogos finitos, recursos no ponderados y costes fijos; los invariantes del ejecutor requieren mensajes coherentes. La dinámica continua, el contacto, la localización y la red imperfecta se evalúan mediante contratos distintos.
...
Estos invariantes certifican exclusión lógica de celdas en los instantes muestreados. La separación euclídea entre muestras depende de que la inflación represente la huella orientada y de que la interpolación respete esa envolvente. La ejecución física añade para ello una guardia como la de E5.
