...
Recíprocamente, en un perfil con $q_k=n_k$ para toda carga, un robot asignado que pasa a inactividad crea una unidad de déficit y ahorra como máximo $\kappa_{\max}$; trasladarlo a otra carga crea una unidad de déficit y una de exceso; y un robot inactivo que entra crea exceso. Como $\lambda>\kappa_{\max}$, ninguna desviación es rentable. Los Nash puros coinciden exactamente con los perfiles de cuotas correctas.
