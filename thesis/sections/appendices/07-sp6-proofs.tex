...
La enumeración exhaustiva de los perfiles binarios comprueba, para cada mundo confirmatorio, la identidad de potencial ante toda desviación unilateral, las condiciones de Nash, la factibilidad, la minimalidad, el ascenso estricto y el límite de $2^{n_R}-1$ cambios. Estas comprobaciones confirman los enunciados finitos, pero no sustituyen las demostraciones anteriores ni añaden garantías físicas fuera del modelo.
