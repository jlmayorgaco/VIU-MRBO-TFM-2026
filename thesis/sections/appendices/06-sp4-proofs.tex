...
\[
 ...
 +\frac{1}{2\lambda_D}\|\boldsymbol r_k^W\|_2^2.
\]
La cota establece disipación con \(\boldsymbol r_k^W\) como entrada. Cuando el residual persiste, el término \(\|\boldsymbol r_k^W\|_2^2/(2\lambda_D)\) impide deducir convergencia exacta a partir de esta desigualdad.
