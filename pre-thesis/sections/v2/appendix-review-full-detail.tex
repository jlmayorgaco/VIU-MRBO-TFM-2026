...
\begin{table}[!htbp]
  ...
  \begin{tabularx}{\textwidth}{@{}>{\raggedright\arraybackslash}p{2.15cm} >{\raggedright\arraybackslash}p{3.05cm} >{\raggedright\arraybackslash}p{3.05cm} Y@{}}
    ...
    Qué documenta & mecanismos con formulación y garantía publicadas & capacidades que el fabricante declara en producto & desplazamiento de la actividad de protección \\
