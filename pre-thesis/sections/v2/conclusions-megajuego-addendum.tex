...
\textbf{RQ6.} Sí se certifica por bloque, y el certificado sobrevive al cambio
de motor, pero solo dentro de los dominios que cada resultado declara y sin
que la cadena completa herede una garantía conjunta.
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{@{}p{0.8cm}p{1.75cm}p{5.1cm}X@{}}
    ...
    \midrule
    H6 & Apoyo delimitado & Cuatro resultados demostrados con residuales de verificación por debajo de $10^{-9}$ (Tabla~\ref{tab:megajuego-e2e-summary}); la reproducción en CoppeliaSim conserva el resultado cualitativo (Tabla~\ref{tab:coppelia-compact-narrow}). & Dominios concretos por resultado; ambas campañas con una corrida, sin réplicas ni semillas. \\
    \bottomrule
  \end{tabularx}
  \viuownsource
\end{table}
