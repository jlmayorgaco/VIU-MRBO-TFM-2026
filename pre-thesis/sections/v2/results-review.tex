...
\input{sections/v2/floats/lit-fig-coverage-rubric}
...
\input{sections/v2/floats/lit-fig-stage-coverage}
...
\input{sections/v2/floats/lit-fig-method-change}

\input{sections/v2/floats/lit-fig-period-shift}
...
\input{sections/v2/floats/lit-fig-bibliometric}

La estructura bibliométrica es compatible con esa lectura: núcleos de coautoría
pequeños y aislados, y comunidades de método de modularidad baja
($Q=$\LitMethodModularity{}) sobre el grafo de coocurrencia documental
construido aquí (Figura~\ref{fig:lit-bibliometric}). Una modularidad baja indica
que, bajo esta codificación de familias y este algoritmo de comunidades, las
familias metodológicas no se separan en bloques; no mide la existencia de una
agenda dominante, que este trabajo no ha contrastado.

\input{sections/v2/floats/ind-fig-patents}

La composición temática del corpus patentario recuperado se desplaza hacia decisión
de misión: media móvil de tres años del
...
\begin{table}[!htbp]
  ...
  \begin{tabularx}{\textwidth}{@{}>{\raggedright\arraybackslash}p{4.3cm}
    ...
    Desplazamiento de +20,9 puntos hacia decisión de misión en el corpus patentario
      & OE1 & Muestra un desplazamiento temático reciente del corpus recuperado hacia la capa de decisión, a nivel de publicación y no de familia de patentes; no acredita adopción ni pertinencia industrial demostrada. \\
