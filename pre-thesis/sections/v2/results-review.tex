...
37,9~\% al 58,8~\% entre el cierre de 2022 y el de 2025 (+20,9~puntos, robusto a la
ampliación dirigida por solicitante),
mientras coordinación cinemática e interacción física bajan (Figura~\ref{fig:results-patents}).
...
\begin{table}[!htbp]
  ...
  \begin{tabularx}{\textwidth}{@{}>{\raggedright\arraybackslash}p{4.3cm}
    ...
    Desplazamiento de +20,9 puntos hacia decisión de misión en el corpus patentario
      & OE1 & Confirma pertinencia industrial de la capa estratégica y justifica el peso de SP1 en la campaña. \\
