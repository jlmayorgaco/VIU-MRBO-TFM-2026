...
\begin{table}[!htbp]
  ...
  \begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}p{2.6cm} >{\raggedright\arraybackslash}p{1.9cm} Y}
    ...
    Imitación / red neuronal & $O(NKd)$ o $O(NKP)$ & evaluación empírica; sin certificado combinatorio \\
...
($\SPTwoNeuralSuccess$) y del oráculo MILP ($\SPTwoScoreSuccess$). No se
evaluó combinada con los métodos aproximados de la Tabla~\ref{tab:sp1-compact-e2-methods}.
