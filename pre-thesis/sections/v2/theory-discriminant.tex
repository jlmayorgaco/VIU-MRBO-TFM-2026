...
canónico sobre los ejes de autoridad de decisión y explicitud del mecanismo, y muestra
un campo dividido: los trabajos de coalición y MRTA se concentran en la decisión lógica
y los de transporte cooperativo en la ejecución física, con muy poca población en la
franja que los conecta.

\input{sections/v2/floats/lit-fig-methodological-map}
...
\input{sections/v2/floats/lit-fig-capability-matrix}
