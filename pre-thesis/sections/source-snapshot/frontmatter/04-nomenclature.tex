...
\begin{description}[style=multiline,leftmargin=8.2em,labelwidth=7.2em,itemsep=0.15em,parsep=0pt]
  ...
  \item[$X,\mathcal B_N$] Asignación relajada y politopo de matrices doblemente estocásticas de la etapa E0 de SP1.
  \item[$\pi_k,\rho,\gamma,\tau$] Precio de tarea y parámetros primal--dual/entrópicos candidatos de la etapa E0 de SP1.
  \item[$\mathcal G_A,\mathcal G_C$] Grafos de asignación y de comunicación robot--robot de la etapa E0 de SP1.
  ...
  \item[$c_i^{\mathrm{pay}},c^{\mathrm{ref}}$] Carga útil nominal, en kg, y escala de referencia de la etapa E2 de SP1, en kg.
  ...
  \item[$a_{ik},e_{ik}$] Disponibilidad operacional y contribución normalizada de servicio de la etapa E2 de SP1. Ambas adimensionales.
  \item[$d_k^{\mathrm{srv}}$] Umbral adimensional de servicio operacional de la carga $k$ en la etapa E2 de SP1.
  ...
  \item[$h_j,v_k^{\mathrm{fil}}$] Holgura de barrera, en m, y velocidad traslacional filtrada, en m/s, de la etapa E5 de SP2.
  ...
  \item[$\mathcal R_i^7,P_7,\theta_7$] Catálogo de rutas, pares en conflicto y umbral suficiente de penalización de la etapa E7 de SP3.
  \item[$\mathcal E_{ir}^8,G_C^8$] Recursos ocupados por una ruta y grafo de comunicación entre coaliciones de la etapa E8 de SP3.
  ...
  \item[SP] Subproblema canónico: SP1, formación; SP2, ejecución; o SP3, tráfico multi-coalición.
  \item[VE] Equilibrio variacional.
  \item[VO/RVO] \emph{Velocity Obstacle} y \emph{Reciprocal Velocity Obstacle}.
\end{description}
La barra en $\bar\delta_{ik}$ distingue la distancia normalizada de la distancia física $\delta_{ik}$. Las decoraciones de \(\rho\) separan magnitudes distintas: \(\rho_{ik}\) es una preferencia, \(\rho_D\) un parámetro primal--dual y \(\rho_k^W\) el residual de \emph{wrench}.
