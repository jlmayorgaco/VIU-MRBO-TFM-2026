\subsection{Demostraciones complementarias de la etapa E1 (SP1)}
\label{app:sp1-proofs}

Las proposiciones de E1 se refieren a una decisión lógica estática con robots homogéneos, costes adimensionales y ocupación coherente. La dinámica Smith muestreada, la comunicación vecinal y la factibilidad mecánica poseen modelos adicionales y quedan fuera de estos enunciados.
...
\estadoaporte{demostrado por reducción a asignación y desde mochila 0--1, respectivamente.}
...
\begin{figure}[H]
 \centering
 \includegraphics[width=0.76\textwidth]{figures/generated/sp1-beta-regime-map.pdf}
