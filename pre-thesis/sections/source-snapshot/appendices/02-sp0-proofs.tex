\subsection{Demostraciones complementarias de la etapa E0 (SP1)}
\label{app:sp0-proofs}

E0 relaciona la complejidad de la asignación uno a uno con la dinámica de mejora del juego. El resultado de complejidad usa costes normalizados. La prueba de terminación opera sobre un espacio de acciones finito, y la factibilidad del equilibrio invoca \(\lambda>\kappa_{\max}\).
