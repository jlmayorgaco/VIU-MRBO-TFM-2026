\subsubsection{Etapa 3.3: piloto AWS Industrial}
\label{subsubsec:sp3-aws-industrial2}
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.50\textwidth]{figures/coppelia/aws-industrial-oblique-camera.png}
...
Se cruzaron cuatro métodos, cuatro escenarios y dos semillas: \AwsPilotRuns{} ejecuciones de \AwsPilotHorizon{}~s. La referencia central usa un MILP instantáneo global sin planificación espacio--temporal. Subasta, reciprocidad y predictor son \emph{proxies} que no reproducen CBBA, ORCA o DMPC. En el escenario abierto, Central MILP + preview obtuvo \AwsOpenCentralDeliveries{}, Auction + reciprocal proxy \AwsOpenAuctionDeliveries{}, Auction + predictive CBF proxy \AwsOpenPredictiveDeliveries{} y Replicator + CBF (TFM) \AwsOpenTfmDeliveries{} cargas por ejecución; los otros tres escenarios obtuvieron cero. La referencia central optimiza la asignación de cada instantánea, pero no anticipa reservas espacio--temporales. Su valor \AwsOpenCentralDeliveries{} documenta un bloqueo del ejecutor integrado y no un fallo del MILP de asignación.

Las \AwsPilotRuns{} ejecuciones no registraron solapamientos muestreados, pero el verificador contabilizó \AwsSafeBarrierViolations{} violaciones de la desigualdad de barrera: residual seguro máximo $\AwsMaxSafeBarrierResidual{}$ y residual ejecutado máximo $\AwsMaxExecBarrierResidual{}$. La discrepancia distingue el certificado algebraico de la intersección geométrica muestreada. Replicator--CBF permaneció bloqueado durante una fracción \AwsTfmDeadlockMin{}--\AwsTfmDeadlockMax{} del tiempo simulado; dos semillas no permiten establecer un ranking ni estimar fiabilidad industrial.
